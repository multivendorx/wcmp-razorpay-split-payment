...
The much awaited <strong>WCMp Razorpay Split Payment</strong> is now live.

<strong>WCMp Razorpay Split Payment</strong> is a <strong>WC Marketplace</strong> add-on that allows instant (chain or parallel) payment to vendors.
...
To know more about WCMp Razorpay Split Payment, please <a href="http://wc-marketplace.com/knowledgebase/wcmp-razorpay-Checkout-gateway/">visit us</a>

== Installation ==

NOTE:  WCMp Razorpay Split Payment plugin is an extension of WooCommerce as well as WC Marketplace. As such, Woocommerce and WC Marketplace plugin 
...
4. Download and install WCMp Razorpay Split Payment plugin using the built-in Word Press plugin installer. If you download WCMp Razorpay Split Payment plugin 
